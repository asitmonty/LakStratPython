...
def generateFortClusters(playerIDs, allianceIDs, max_fort_radius):
   ...
   # df_player_habitat_data.to_csv('player_habitat_comma.csv', encoding='utf-8')
    ...
    for playerID in playerIDList:
        ...
        json_habitat_data_output = lastUpdateDate + "/" + output_file_prefix + numpy.array_str(playerID) + ".json"
        ...
        json_fort_clusters_output_file = lastUpdateDate + "/" + output_file_prefix + numpy.array_str(playerID) + ".json"
